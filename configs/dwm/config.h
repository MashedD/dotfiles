...
static const char *maimcmd[] = {"maim", "-u", NULL};
static const char *maimclip[] = {"maim", "-u", "-s", "|", "xclip", "-selection", "clipboard", "-t", "image/png", NULL};
static const char *fonts[]          = { "monospace:size=10" };
static const char dmenufont[]       = "monospace:size=10";
static const char col0[] = "#000000"; // black (borders)
static const char col1[] = "#C0C0C0"; // light gray (bar background)
static const char col2[] = "#FFFFFF"; // white (text)
static const char col3[] = "#808080"; // dark gray (inactive text)
static const char col4[] = "#000080"; // navy blue (selections)

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col0, col1, col0 },
	[SchemeSel]  = { col2, col4, col0 },
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = mc } },
